...
public class ExcelWrite {
    ...
    public static boolean writeExcel(String filepath, String sheetName, List<String> titles,
        ...
        if (StringUtils.isBlank(filepath)) {
            ...
            //合并单元格
//            CellRangeAddress rangeAddress = new CellRangeAddress(0, 0, 1, 2);
//            sheet.addMergedRegion(rangeAddress);
    ...
    public static void main(String[] args) {
        String filepath = "d://newExcel.xlsx";
        String sheetName = "tongji";
        ...
        try {
            writeExcel(filepath, sheetName,titles,values);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
